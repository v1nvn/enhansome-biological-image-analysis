...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 87,265 | 🐛 2,742 | 🌐 C++ | 📅 2026-04-27 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,503 | 🐛 899 | 🌐 Python | 📅 2026-04-28 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,644 | 🐛 1,185 | 🌐 Python | 📅 2026-04-27 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,427 | 🐛 663 | 🌐 C++ | 📅 2026-04-27 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
* [ImageJ2](https://github.com/imagej/imagej2) ⭐ 1,364 | 🐛 133 | 🌐 Java | 📅 2025-08-12 - A Rewrite of ImageJ for multidimensional image data, with a focus on scientific imaging.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,115 | 🐛 298 | 🌐 Python | 📅 2026-04-24 - Open-source software helping biologists turn images into cell measurements.
* [Fiji](https://github.com/fiji/fiji) ⭐ 961 | 🐛 134 | 🌐 Shell | 📅 2026-04-23 - A "batteries-included" distribution of ImageJ — a popular, free scientific image processing application.
* [ImageJ](https://github.com/imagej/ImageJ) ⭐ 749 | 🐛 85 | 🌐 Java | 📅 2026-04-26 - Public domain software for processing and analyzing scientific images.
* [Ilastik](https://github.com/ilastik/ilastik) ⭐ 397 | 🐛 590 | 🌐 Python | 📅 2026-04-27 - Simple, user-friendly tool for interactive image classification, segmentation and analysis.
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 194 | 🐛 61 | 🌐 Python | 📅 2026-04-27 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
* [CellProfiler Analyst](https://github.com/CellProfiler/CellProfiler-Analyst) ⭐ 168 | 🐛 72 | 🌐 Python | 📅 2025-07-21 - Open-source software for exploring and analyzing large, high-dimensional image-derived data.
* [PYME](https://github.com/python-microscopy/python-microscopy) ⭐ 97 | 🐛 164 | 🌐 Python | 📅 2026-04-23 - Open-source application suite for light microscopy acquisition, data storage, visualization, and analysis.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,177 | 🐛 96 | 🌐 Python | 📅 2026-04-22 - A generalist algorithm for cell and nucleus segmentation.
* [StarDist](https://github.com/stardist/stardist) ⭐ 1,208 | 🐛 69 | 🌐 Python | 📅 2026-02-14 - Object detection with Star-convex shapes.
* [HoVer-Net](https://github.com/vqdang/hover_net) ⭐ 707 | 🐛 68 | 🌐 Python | 📅 2023-10-27 - A multi-branch network for nuclear instance segmentation and classification with pre-trained weights.
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 680 | 🐛 83 | 🌐 Jupyter Notebook | 📅 2026-04-27 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 566 | 🐛 100 | 🌐 Python | 📅 2026-04-27 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
* [DeepSlide](https://github.com/BMIRDS/deepslide) ⭐ 516 | 🐛 0 | 🌐 Python | 📅 2024-06-07 - A sliding window framework for classification of high resolution microscopy images.
* [DeepCell](https://github.com/vanvalenlab/deepcell-tf) ⭐ 474 | 🐛 55 | 🌐 Python | 📅 2024-08-30 - Deep learning library for single cell analysis.
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 445 | 🐛 55 | 🌐 Python | 📅 2026-04-18 - Pipeline for processing two-photon calcium imaging data.
...
* [CellVit++](https://github.com/TIO-IKIM/CellViT) ⭐ 374 | 🐛 21 | 🌐 Python | 📅 2025-07-23 - A framework for lightweight cell segmentation model training and inference.
...
* [CellSAM](https://github.com/vanvalenlab/cellSAM) ⭐ 194 | 🐛 45 | 🌐 Python | 📅 2025-11-11 - A foundation model for cell segmentation trained on a diverse range of cells and data types.
* [Proseg](https://github.com/dcjones/proseg) ⭐ 167 | 🐛 75 | 🌐 Rust | 📅 2026-04-28 : A cell segmentation method for in situ spatial transcriptomics.
...
* [MorpholibJ](https://github.com/ijpb/MorphoLibJ) ⭐ 120 | 🐛 24 | 🌐 Java | 📅 2026-04-22 - Collection of mathematical morphology methods and plugins for ImageJ.
* [Ark-Analysis](https://github.com/angelolab/ark-analysis) ⭐ 105 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2026-01-07 - A pipeline toolbox for analyzing multiplexed imaging data.
* [Nellie](https://github.com/aelefebv/nellie) ⭐ 94 | 🐛 4 | 🌐 Python | 📅 2026-01-14 - Automated organelle segmentation, tracking, and hierarchical feature extraction in 2D/3D live-cell microscopy.
...
* [MAPS](https://github.com/mahmoodlab/MAPS) ⭐ 65 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-03-14 - MAPS (Machine learning for Analysis of Proteomics in Spatial biology) is a machine learning approach facilitating rapid and precise cell type identification with human-level accuracy from spatial proteomics data.
...
* [PartSeg](https://github.com/4DNucleome/PartSeg) ⭐ 36 | 🐛 21 | 🌐 Python | 📅 2026-04-27 - A GUI and a library for segmentation algorithms.
...
* [Classpose](https://github.com/sohmandal/classpose) ⭐ 24 | 🐛 2 | 🌐 Python | 📅 2026-04-04 - A foundation model-driven whole slide image-scale cell phenotyping method with QuPath integration.
...
* [FlashDeconv](https://github.com/cafferychen777/flashdeconv) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2026-03-16 - High-performance spatial transcriptomics deconvolution for cell type mapping using structure-preserving randomized sketching.
...
* [ThermImageJ](https://github.com/gtatters/ThermImageJ) ⭐ 55 | 🐛 1 | 🌐 ImageJ Macro | 📅 2024-05-28 - ImageJ functions and macros for working with thermal image files.

## Neuroscience

* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,314 | 🐛 206 | 🌐 TypeScript | 📅 2026-04-23 - WebGL-based viewer for volumetric data.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 641 | 🐛 12 | 🌐 Python | 📅 2026-04-15 - Python package for the visualization of three dimensional neuro-anatomical data.
* [Cellfinder](https://github.com/brainglobe/cellfinder) ⭐ 227 | 🐛 84 | 🌐 Python | 📅 2026-04-16 - Automated 3D cell detection and registration of whole-brain images.
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 191 | 🐛 0 | 🌐 Python | 📅 2026-04-27 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 180 | 🐛 229 | 🌐 Python | 📅 2026-04-27 - A lightweight Python module to interact with atlases for systems neuroscience.
* [CloudVolume](https://github.com/seung-lab/cloud-volume) ⭐ 171 | 🐛 90 | 🌐 Python | 📅 2026-04-24 - Read and write Neuroglancer datasets programmatically.
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 147 | 🐛 19 | 🌐 Python | 📅 2026-04-08 - Automated 3D brain registration with support for multiple species and atlases.
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 125 | 🐛 47 | 🌐 Python | 📅 2026-04-17 - Segment axon and myelin from microscopy data using deep learning.
...
* [SNT](https://github.com/morphonets/SNT/) ⭐ 59 | 🐛 12 | 🌐 Java | 📅 2026-04-27 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 784 | 🐛 114 | 🌐 Python | 📅 2026-04-24 - Open-source image analysis software package targeted for plant phenotyping.
* [PlantSeg](https://github.com/hci-unihd/plant-seg) ⭐ 125 | 🐛 34 | 🌐 Python | 📅 2026-04-27 - Tool for cell instance aware segmentation in densely packed 3D volumetric images.
* [RootPainter](https://github.com/Abe404/root_painter) ⭐ 76 | 🐛 37 | 🌐 Python | 📅 2026-04-14 - Deep learning segmentation of biological images with corrective annotation.
...
* [Rhizovision Explorer](https://github.com/rootphenomicslab/RhizoVisionExplorer) ⭐ 28 | 🐛 8 | 🌐 C++ | 📅 2025-10-21 - Free and open-source software developed for estimating root traits from images acquired from a flatbed scanner or camera.
...
* [Spotiflow](https://github.com/weigertlab/spotiflow) ⭐ 124 | 🐛 6 | 🌐 Python | 📅 2026-02-05 - A deep learning-based, threshold-agnostic, and subpixel-accurate spot detection method developed for spatial transcriptomics workflows.
...
* [Picasso](https://github.com/jungmannlab/picasso) ⭐ 141 | 🐛 17 | 🌐 Python | 📅 2026-04-10 - A collection of tools for painting super-resolution images.
...
* [SMAP](https://github.com/jries/SMAP) ⭐ 82 | 🐛 14 | 🌐 MATLAB | 📅 2026-04-16 - A modular super-resolution microscopy analysis platform for SMLM data.
...
* [Image Quality](https://github.com/ocampor/image-quality) ⭐ 434 | 🐛 21 | 🌐 Python | 📅 2024-02-05 - Open source software library for Image Quality Assessment (IQA).
* [CSBDeep](https://github.com/CSBDeep/CSBDeep) ⭐ 332 | 🐛 26 | 🌐 Python | 📅 2025-12-08 - A deep learning toolbox for microscopy image restoration and analysis.
* [LLSpy](https://github.com/tlambert03/LLSpy) ⭐ 30 | 🐛 5 | 🌐 Python | 📅 2026-04-06 - Python library to facilitate lattice light sheet data processing.
...
* [TrackMate](https://github.com/fiji/TrackMate) ⭐ 235 | 🐛 14 | 🌐 Java | 📅 2026-03-25 - User-friendly interface that allows for performing tracking, data visualization, editing results and track analysis in a convenient way.
...
* [Ultrack](https://github.com/royerlab/ultrack) ⭐ 176 | 🐛 71 | 🌐 Python | 📅 2026-04-21 - Versatile cell tracking method for 2D, 3D, and multichannel timelapses, overcoming segmentation challenges in complex tissues.
...
* [PathML](https://github.com/Dana-Farber-AIOS/pathml) ⭐ 449 | 🐛 50 | 🌐 Python | 📅 2026-04-14 - An open-source toolkit for computational pathology and machine learning.
...
* [PAQUO](https://github.com/bayer-science-for-a-better-life/paquo) ⭐ 134 | 🐛 36 | 🌐 Python | 📅 2026-03-14 - A library for interacting with QuPath from Python.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,055 | 🐛 79 | 🌐 C++ | 📅 2026-04-24 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
* [ZeroCostDL4Mic](https://github.com/HenriquesLab/ZeroCostDL4Mic) ⭐ 638 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-03-29 - Google Colab to develop a free and open-source toolbox for deep-Learning in microscopy.
* [Neurite](https://github.com/adalca/neurite) ⭐ 375 | 🐛 20 | 🌐 Python | 📅 2026-04-26 - Neural networks toolbox focused on medical image analysis.
...
* [OAD](https://github.com/zeiss-microscopy/OAD) ⭐ 163 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-04-06 - Collection of tools and scripts useful to automate microscopy workflows in ZEN Blue using Python and Open Application Development tools.
* [Pycytominer](https://github.com/cytomining/pycytominer) ⭐ 137 | 🐛 70 | 🌐 Python | 📅 2026-04-24 - Data processing functions for profiling perturbations.
...
* [BoneJ](https://github.com/bonej-org/BoneJ2) ⭐ 26 | 🐛 35 | 🌐 Java | 📅 2026-03-17 - Collection of Fiji/ImageJ plug-ins for skeletal biology.
...
* [MIA](https://github.com/mianalysis/mia) ⭐ 16 | 🐛 45 | 🌐 Java | 📅 2026-03-31 - Fiji plugin which provides a modular framework for assembling image and object analysis workflows.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 8 | 🐛 2 | 🌐 MATLAB | 📅 2026-04-26 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
