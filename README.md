...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 87,687 | 🐛 2,722 | 🌐 C++ | 📅 2026-05-29 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,519 | 🐛 909 | 🌐 Python | 📅 2026-05-26 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,663 | 🐛 1,202 | 🌐 Python | 📅 2026-05-29 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,481 | 🐛 682 | 🌐 C++ | 📅 2026-05-29 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
* [ImageJ2](https://github.com/imagej/imagej2) ⭐ 1,374 | 🐛 133 | 🌐 Java | 📅 2025-08-12 - A Rewrite of ImageJ for multidimensional image data, with a focus on scientific imaging.
* [ImagePy](https://github.com/Image-Py/imagepy) ⭐ 1,357 | 🐛 58 | 🌐 Python | 📅 2024-02-21 - Open source image processing framework written in Python.
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,117 | 🐛 301 | 🌐 Python | 📅 2026-05-29 - Open-source software helping biologists turn images into cell measurements.
* [Fiji](https://github.com/fiji/fiji) ⭐ 976 | 🐛 136 | 🌐 Shell | 📅 2026-05-12 - A "batteries-included" distribution of ImageJ — a popular, free scientific image processing application.
* [ImageJ](https://github.com/imagej/ImageJ) ⭐ 757 | 🐛 86 | 🌐 Java | 📅 2026-05-22 - Public domain software for processing and analyzing scientific images.
* [Ilastik](https://github.com/ilastik/ilastik) ⭐ 397 | 🐛 574 | 🌐 Python | 📅 2026-05-28 - Simple, user-friendly tool for interactive image classification, segmentation and analysis.
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 196 | 🐛 71 | 🌐 Python | 📅 2026-05-28 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
* [CellProfiler Analyst](https://github.com/CellProfiler/CellProfiler-Analyst) ⭐ 170 | 🐛 72 | 🌐 Python | 📅 2025-07-21 - Open-source software for exploring and analyzing large, high-dimensional image-derived data.
* [PYME](https://github.com/python-microscopy/python-microscopy) ⭐ 97 | 🐛 173 | 🌐 Python | 📅 2026-05-08 - Open-source application suite for light microscopy acquisition, data storage, visualization, and analysis.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,218 | 🐛 105 | 🌐 Python | 📅 2026-05-27 - A generalist algorithm for cell and nucleus segmentation.
* [StarDist](https://github.com/stardist/stardist) ⭐ 1,218 | 🐛 69 | 🌐 Python | 📅 2026-02-14 - Object detection with Star-convex shapes.
* [HoVer-Net](https://github.com/vqdang/hover_net) ⭐ 715 | 🐛 68 | 🌐 Python | 📅 2023-10-27 - A multi-branch network for nuclear instance segmentation and classification with pre-trained weights.
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 684 | 🐛 73 | 🌐 Jupyter Notebook | 📅 2026-05-28 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 572 | 🐛 106 | 🌐 Python | 📅 2026-05-29 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
* [DeepSlide](https://github.com/BMIRDS/deepslide) ⭐ 514 | 🐛 0 | 🌐 Python | 📅 2024-06-07 - A sliding window framework for classification of high resolution microscopy images.
* [DeepCell](https://github.com/vanvalenlab/deepcell-tf) ⭐ 473 | 🐛 56 | 🌐 Python | 📅 2024-08-30 - Deep learning library for single cell analysis.
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 449 | 🐛 54 | 🌐 Python | 📅 2026-05-03 - Pipeline for processing two-photon calcium imaging data.
* [CellVit++](https://github.com/TIO-IKIM/CellViT) ⭐ 382 | 🐛 22 | 🌐 Python | 📅 2025-07-23 - A framework for lightweight cell segmentation model training and inference.
...
* [AtomAI](https://github.com/pycroscopy/atomai) ⭐ 229 | 🐛 11 | 🌐 Python | 📅 2025-06-24 - PyTorch-based package for deep/machine learning analysis of microscopy data.
* [CellSAM](https://github.com/vanvalenlab/cellSAM) ⭐ 197 | 🐛 46 | 🌐 Python | 📅 2026-05-26 - A foundation model for cell segmentation trained on a diverse range of cells and data types.
* [Proseg](https://github.com/dcjones/proseg) ⭐ 172 | 🐛 77 | 🌐 Rust | 📅 2026-05-18 : A cell segmentation method for in situ spatial transcriptomics.
* [Trainable Weka Segmentation](https://github.com/fiji/Trainable_Segmentation) ⭐ 124 | 🐛 29 | 🌐 Java | 📅 2024-09-28 - Fiji plugin and library that combines a collection of machine learning algorithms with a set of selected image features to produce pixel-based segmentations.
* [MorpholibJ](https://github.com/ijpb/MorphoLibJ) ⭐ 123 | 🐛 24 | 🌐 Java | 📅 2026-05-07 - Collection of mathematical morphology methods and plugins for ImageJ.
* [Ark-Analysis](https://github.com/angelolab/ark-analysis) ⭐ 105 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2026-01-07 - A pipeline toolbox for analyzing multiplexed imaging data.
* [Nellie](https://github.com/aelefebv/nellie) ⭐ 95 | 🐛 4 | 🌐 Python | 📅 2026-05-15 - Automated organelle segmentation, tracking, and hierarchical feature extraction in 2D/3D live-cell microscopy.
...
* [PartSeg](https://github.com/4DNucleome/PartSeg) ⭐ 37 | 🐛 27 | 🌐 Python | 📅 2026-05-25 - A GUI and a library for segmentation algorithms.
...
* [Classpose](https://github.com/sohmandal/classpose) ⭐ 27 | 🐛 3 | 🌐 Python | 📅 2026-05-27 - A foundation model-driven whole slide image-scale cell phenotyping method with QuPath integration.
...
* [FlashDeconv](https://github.com/cafferychen777/flashdeconv) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-03-16 - High-performance spatial transcriptomics deconvolution for cell type mapping using structure-preserving randomized sketching.
...
* [ThermImageJ](https://github.com/gtatters/ThermImageJ) ⭐ 55 | 🐛 0 | 🌐 ImageJ Macro | 📅 2024-05-28 - ImageJ functions and macros for working with thermal image files.

## Neuroscience

* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,328 | 🐛 224 | 🌐 TypeScript | 📅 2026-05-28 - WebGL-based viewer for volumetric data.
* [CaImAn](https://github.com/flatironinstitute/CaImAn) ⭐ 723 | 🐛 100 | 🌐 Python | 📅 2026-04-16 - Computational toolbox for large scale Calcium Imaging Analysis.
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 653 | 🐛 8 | 🌐 Python | 📅 2026-05-26 - Python package for the visualization of three dimensional neuro-anatomical data.
* [Cellfinder](https://github.com/brainglobe/cellfinder) ⭐ 228 | 🐛 83 | 🌐 Python | 📅 2026-05-22 - Automated 3D cell detection and registration of whole-brain images.
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 192 | 🐛 1 | 🌐 Python | 📅 2026-05-29 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 180 | 🐛 234 | 🌐 Python | 📅 2026-05-29 - A lightweight Python module to interact with atlases for systems neuroscience.
* [CloudVolume](https://github.com/seung-lab/cloud-volume) ⭐ 173 | 🐛 91 | 🌐 Python | 📅 2026-05-29 - Read and write Neuroglancer datasets programmatically.
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 149 | 🐛 18 | 🌐 Python | 📅 2026-05-05 - Automated 3D brain registration with support for multiple species and atlases.
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 126 | 🐛 47 | 🌐 Python | 📅 2026-05-29 - Segment axon and myelin from microscopy data using deep learning.
...
* [NeuroAnatomy Toolbox](https://github.com/natverse/nat) ⭐ 77 | 🐛 58 | 🌐 R | 📅 2026-04-16 - R package for the (3D) visualisation and analysis of biological image data, especially tracings of single neurons.
* [SNT](https://github.com/morphonets/SNT/) ⭐ 60 | 🐛 11 | 🌐 Java | 📅 2026-05-29 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 795 | 🐛 129 | 🌐 Python | 📅 2026-05-29 - Open-source image analysis software package targeted for plant phenotyping.
* [PlantSeg](https://github.com/hci-unihd/plant-seg) ⭐ 125 | 🐛 33 | 🌐 Python | 📅 2026-05-28 - Tool for cell instance aware segmentation in densely packed 3D volumetric images.
* [RootPainter](https://github.com/Abe404/root_painter) ⭐ 78 | 🐛 38 | 🌐 Python | 📅 2026-04-30 - Deep learning segmentation of biological images with corrective annotation.
* [Aradeepopsis](https://github.com/Gregor-Mendel-Institute/aradeepopsis) ⭐ 51 | 🐛 3 | 🌐 Nextflow | 📅 2025-05-26 - A versatile, fully open-source pipeline to extract phenotypic measurements from plant images.
* [Rhizovision Explorer](https://github.com/rootphenomicslab/RhizoVisionExplorer) ⭐ 29 | 🐛 8 | 🌐 C++ | 📅 2025-10-21 - Free and open-source software developed for estimating root traits from images acquired from a flatbed scanner or camera.
...
* [Spotiflow](https://github.com/weigertlab/spotiflow) ⭐ 129 | 🐛 6 | 🌐 Python | 📅 2026-02-05 - A deep learning-based, threshold-agnostic, and subpixel-accurate spot detection method developed for spatial transcriptomics workflows.
* [Big-fish](https://github.com/fish-quant/big-fish) ⭐ 76 | 🐛 19 | 🌐 Python | 📅 2023-10-31 - Python package for the analysis of smFISH images.
* [RS-FISH](https://github.com/PreibischLab/RS-FISH) ⭐ 52 | 🐛 10 | 🌐 Java | 📅 2025-02-04 - Fiji plugin to detect FISH spots in 2D/3D images which scales to very large images.
* [DypFISH](https://github.com/cbib/dypfish) ⭐ 3 | 🐛 13 | 🌐 Python | 📅 2023-10-03 - Python library for spatial analysis of smFISH images.
...
* [Picasso](https://github.com/jungmannlab/picasso) ⭐ 144 | 🐛 5 | 🌐 Python | 📅 2026-05-29 - A collection of tools for painting super-resolution images.
...
* [SMAP](https://github.com/jries/SMAP) ⭐ 84 | 🐛 14 | 🌐 MATLAB | 📅 2026-05-24 - A modular super-resolution microscopy analysis platform for SMLM data.
...
* [Empanada](https://github.com/volume-em/empanada) ⭐ 2 | 🐛 7 | 🌐 Python | 📅 2023-02-25 - Panoptic segmentation algorithms for 2D and 3D electron microscopy images.
...
* [CSBDeep](https://github.com/CSBDeep/CSBDeep) ⭐ 335 | 🐛 26 | 🌐 Python | 📅 2025-12-08 - A deep learning toolbox for microscopy image restoration and analysis.
* [LLSpy](https://github.com/tlambert03/LLSpy) ⭐ 30 | 🐛 5 | 🌐 Python | 📅 2026-05-04 - Python library to facilitate lattice light sheet data processing.
...
* [TrackMate](https://github.com/fiji/TrackMate) ⭐ 234 | 🐛 18 | 🌐 Java | 📅 2026-03-25 - User-friendly interface that allows for performing tracking, data visualization, editing results and track analysis in a convenient way.
...
* [Ultrack](https://github.com/royerlab/ultrack) ⭐ 177 | 🐛 74 | 🌐 Python | 📅 2026-05-14 - Versatile cell tracking method for 2D, 3D, and multichannel timelapses, overcoming segmentation challenges in complex tissues.
...
* [PathML](https://github.com/Dana-Farber-AIOS/pathml) ⭐ 452 | 🐛 50 | 🌐 Python | 📅 2026-04-14 - An open-source toolkit for computational pathology and machine learning.
* [FastPathology](https://github.com/AICAN-Research/FAST-Pathology) ⭐ 142 | 🐛 26 | 🌐 C++ | 📅 2024-06-14 - Open-source software for deep learning-based digital pathology.
* [PAQUO](https://github.com/bayer-science-for-a-better-life/paquo) ⭐ 134 | 🐛 35 | 🌐 Python | 📅 2026-04-30 - A library for interacting with QuPath from Python.
...
* [DeepMushroom](https://github.com/Olament/DeepMushroom) ⭐ 71 | 🐛 1 | 🌐 Go | 📅 2020-02-06 - Image classification of fungus using ResNet.
...
* [YeaZ](https://github.com/lpbsscientist/YeaZ-GUI) ⭐ 29 | 🐛 3 | 🌐 Python | 📅 2026-01-14 - An interactive tool for segmenting yeast cells using deep learning.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,061 | 🐛 84 | 🌐 C++ | 📅 2026-05-27 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
* [ZeroCostDL4Mic](https://github.com/HenriquesLab/ZeroCostDL4Mic) ⭐ 642 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-03-29 - Google Colab to develop a free and open-source toolbox for deep-Learning in microscopy.
* [Neurite](https://github.com/adalca/neurite) ⭐ 375 | 🐛 20 | 🌐 Python | 📅 2026-05-18 - Neural networks toolbox focused on medical image analysis.
...
* [OAD](https://github.com/zeiss-microscopy/OAD) ⭐ 165 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-05-22 - Collection of tools and scripts useful to automate microscopy workflows in ZEN Blue using Python and Open Application Development tools.
* [Pycytominer](https://github.com/cytomining/pycytominer) ⭐ 138 | 🐛 55 | 🌐 Python | 📅 2026-05-27 - Data processing functions for profiling perturbations.
* [Pyotf](https://github.com/david-hoffman/pyotf) ⭐ 83 | 🐛 7 | 🌐 Python | 📅 2024-04-08 - A simulation software package for modelling optical transfer functions (OTF)/point spread functions (PSF) of optical microscopes written in Python.
...
* [BoneJ](https://github.com/bonej-org/BoneJ2) ⭐ 26 | 🐛 36 | 🌐 Java | 📅 2026-05-29 - Collection of Fiji/ImageJ plug-ins for skeletal biology.
...
* [MIA](https://github.com/mianalysis/mia) ⭐ 16 | 🐛 45 | 🌐 Java | 📅 2026-05-21 - Fiji plugin which provides a modular framework for assembling image and object analysis workflows.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 8 | 🐛 2 | 🌐 MATLAB | 📅 2026-05-29 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
...
* [OpenMicroscopy](https://github.com/HohlbeinLab/OpenMicroscopy) ⭐ 177 | 🐛 0 | 📅 2026-03-19 - Non-comprehensive list of projects and resources related to open microscopy.
* [Cytodata](https://github.com/cytodata/awesome-cytodata) ⭐ 91 | 🐛 4 | 📅 2023-11-15 - A curated list of awesome cytodata resources.
